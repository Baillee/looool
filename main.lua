...
keybindSection:NewKeybind("Close UI", "Toggle UI", Enum.KeyCode.F4, function()
  Library:ToggleUI()
end)
...
local Section = Credit:NewSection("Script Developed by: Baillee")
Section:NewDropdown("Developer", "Dev", {"Baillee", "Baillee", "Baillee", "Baillee", "Baillee"}, function(currentDeveloper)
    local creations = {
        Baillee = "Owner",
        Baillee = "Head Developer",
        Baillee = "Head Developer",
        Baillee = "Head Developer",
        Baillee = "Head Developer",
    }
...
Section:NewButton("Copy Discord Link", "Discord", function()
    setclipboard("https://discord.gg/H9HmhtKaQp")
end)
